    ...
    <div class="card ">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end" style="padding-top:10px;padding-right:20px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ back_route('extensions.shop.review.show', $review) }}">{{ $review->getAuthorName() }}</a></li>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    @include('administrable-shop::' . Str::lower(config('administrable.back_namespace')) . '.reviews._form',['edit' => true])
                </div>
            </div>
        </div>
    </div>
