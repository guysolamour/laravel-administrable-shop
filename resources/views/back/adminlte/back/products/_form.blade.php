...
<div class="accordion" id="variation_accordion">
    ...
    <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="card-group">
                                @php
                                $frontimage = config('administrable-shop.media_collections', [])['front-image'];
                                @endphp
                        ...
                        @php
                        $backimage = config('administrable-shop.media_collections', [])['back-image'];
                        @endphp
        ...
        @php
        $images = config('administrable-shop.media_collections', [])['images'];
        @endphp
...
<div class="col-md-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="front-image-box image-container">
                @foreach (config('administrable-shop.custom_fields.product', []) as $field)
    ...
    @foreach (config('administrable-shop.media_collections', []) as $collection => $label)
