...
namespace Guysolamour\Administrable\Extensions\Shop\Forms\Back;
...
class CouponForm extends Form
{
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('products', 'entity', [
                "class" => config('administrable-shop.models.product'),
                "property" => 'name',
                "label" => 'Produits',
                'multiple' => true,
            ...
            ->add('categories', 'entity', [
                "class" => config('administrable-shop.models.category'),
                "property" => 'name',
                "label" => 'Catégories',
    ...
    private function getRemiseTypes() :array
    {
        ...
        foreach (config('administrable-shop.models.coupon')::REMISE_TYPES as $value) {
