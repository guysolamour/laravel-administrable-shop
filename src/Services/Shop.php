...
class Shop
{
    ...
    public function defaultDeliver()
    {
         ...
         */
        $default_deliver = config('administrable-shop.models.deliver')::with('areas')->find($settings->default_deliver_id);
    ...
    {
        return config('administrable-shop.client.default.password');
    }
}
