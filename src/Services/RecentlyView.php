...
use Guysolamour\Administrable\Extensions\Shop\Contracts\RecentlyViewContract;


class RecentlyView
{
    /**
     * @param string|\Guysolamour\Administrable\Extensions\Shop\Contracts\RecentlyViewContract $model
    ...
    private function storeInCookie(string $key, int $id) :void
    {
        ...
        Cookie::queue(Cookie::make($this->getCookieName(), json_encode($recent), config('administrable-shop.recently_view_cookie_duration')));
    }
