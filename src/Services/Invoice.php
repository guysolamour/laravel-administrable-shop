...
namespace Guysolamour\Administrable\Extensions\Shop\Services;

use Illuminate\Support\Arr;
use Illuminate\Support\Facades\Storage;
use LaravelDaily\Invoices\Classes\Party;
use Illuminate\Support\Facades\Notification;
use Guysolamour\Administrable\Extensions\Shop\Contracts\HasPdfInvoiceContract;
use Guysolamour\Administrable\Extensions\Shop\Notifications\Front\InvoicePaid;


class Invoice
{
    /**
     * @var \Illuminate\Database\Eloquent\Model|\Guysolamour\Administrable\Extensions\Shop\Contracts\HasPdfInvoiceContract
     */
    private $order;
    ...
    public function send(): void
    {
        ...
        /**
         * @var \Guysolamour\Administrable\Traits\CustomFieldsTrait
         */
        $settings = shop_settings();

        if (!$email || !$settings->getCustomField('send_order_confirmed_client_email')) {
            return;
        }
