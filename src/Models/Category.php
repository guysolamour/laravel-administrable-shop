...
class Category extends BaseModel implements HasMedia
{
    ...
    {
      return $this->belongsToMany(config('administrable-shop.models.product'), 'shop_products_categories');
    }
    ...
    {
        return $this->belongsTo(config('administrable-shop.models.category'), 'parent_id');
    }


    public function children()
    {
        return $this->hasMany(config('administrable-shop.models.category'), 'parent_id');
    }
