...
class Cart {
    ...
    {
        $content =  DB::table(config('administrable-shop.cart_dbname'))->where([
    ...
    private function getNewItemImage($model, ?string $image) :?string
    {
        ...
        throw new CartException("The image is required if the model is not an object and/or does not implements getFrontImageUrl Method");
    }
    ...
    private function getNewItemPrice($model,?int $price) :int
    {
        ...
        throw new CartException("The price is required if the model is not an object and/or does not implements getPrice Method");
    }
    ...
    {
        DB::table(config('administrable-shop.cart_dbname'))
