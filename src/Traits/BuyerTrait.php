...
trait BuyerTrait {
    ...
    {
        return $this->morphMany(config('administrable-shop.models.review'), 'author');
    }


    public function orders()
    {
        return $this->hasMany(config('administrable-shop.models.order'));
    }

    public function coupons()
    {
        return $this->belongsToMany(config('administrable-shop.models.coupon'), 'shop_users_coupons', 'user_id', 'coupon_id')
    ...
    {
        return $this->hasMany(config('administrable-shop.models.command'));
    }
    ...
    {
        $coupon = config('administrable-shop.models.coupon')::firstOrFail($id);
    ...
    {
        return Cart::instance(config('administrable-shop.models.product')::WISHLIST_INSTANCE)->restore();
    }
    ...
    {
        Cart::instance(config('administrable-shop.models.product')::WISHLIST_INSTANCE)->mergeFromSessionToDatabase();
    }
    ...
    {
        Cart::instance(config('administrable-shop.models.product')::WISHLIST_INSTANCE)->clear();
    }
}
